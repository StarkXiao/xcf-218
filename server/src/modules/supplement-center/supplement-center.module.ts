...
import { SupplementCenterController } from './supplement-center.controller';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([MaterialFile, SupplementRecord, Application, ProgressRecord, Message, User]),
  ...
  controllers: [SupplementCenterController],
  providers: [SupplementCenterService],
  exports: [SupplementCenterService],
})
export class SupplementCenterModule {}
